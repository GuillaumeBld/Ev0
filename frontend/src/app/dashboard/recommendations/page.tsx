    ...
    <div className="p-4 md:p-8">
      ...
      <div className="flex flex-wrap gap-3 mb-7">
        ...
        {selectedDate ? (
          ...
          <div className="relative flex items-center gap-2 bg-[#0b0e18] border border-white/[0.07] hover:border-white/15 rounded-full px-3 py-1.5 cursor-pointer transition-colors">
        ...
        {/* Market filter */}
        <div className="flex items-center gap-0.5 bg-[#0b0e18] border border-white/[0.06] rounded-full p-0.5">
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-[#0b0e18] border border-white/[0.05] rounded-xl h-48 animate-pulse" />
          ))}
        </div>
      ...
      {isViewAll && totalPages > 1 && (
        <div className="flex items-center justify-center gap-3 mt-6">
          <button
            ...
            disabled={page === 1}
            className="px-3 py-1.5 bg-[#0b0e18] border border-white/[0.07] text-slate-400 rounded-lg disabled:opacity-30 hover:border-white/15 hover:text-white transition-all text-sm"
          >
            ←
          </button>
