  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-700 hover:bg-ev-surface2 text-white text-sm font-medium transition-colors"
          >
            {enabled
      ...
      <div className="bg-gray-800 rounded-xl p-6 mb-8">
        ...
        {trainingResult && (
          <div className="mt-4 p-4 bg-ev-surface2 rounded-lg text-sm">
        ...
        {optimizationResult && (
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
              <div className="bg-ev-surface2 rounded-lg p-4">
            ...
            {optimizationResult.best_params && (
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-sm bg-ev-surface2 rounded-lg p-3 mb-4">
