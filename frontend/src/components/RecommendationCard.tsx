...
export function RecommendationCard({ recommendation: rec }: RecommendationCardProps) {
  ...
  return (
    <div className={clsx(
      'ev0-rec-card ev0-card-enter bg-[#0b0e18] border border-white/[0.06] border-l-2 rounded-xl overflow-hidden transition-all',
      edgeBorderColor,
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="mt-4 flex items-center gap-3">
          <div className="flex-1 bg-[#0f1420] border border-white/[0.05] rounded-lg p-3">
