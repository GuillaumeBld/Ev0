...
CANONICAL_TEAMS: list[tuple[str, list[str]]] = [
    ...
    ("Leipzig",             ["RB Leipzig", "Red Bull Leipzig", "RasenBallsport Leipzig"]),
    ("Mönchengladbach",     ["Borussia Mönchengladbach", "B. Mönchengladbach", "Monchengladbach", "Borussia M.Gladbach"]),
    ("Francfort",           ["Eintracht Frankfurt", "Frankfurt"]),
    ("Stuttgart",           ["VfB Stuttgart", "Stuttgart"]),
    ("Fribourg",            ["Freiburg", "SC Freiburg", "Sport-Club Freiburg"]),
    ...
    ("Heidenheim",          ["Heidenheim", "1. FC Heidenheim", "FC Heidenheim", "1. FC Heidenheim 1846"]),
