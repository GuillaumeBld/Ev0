...
def upgrade() -> None:
    ...
    op.add_column('player_stats', sa.Column('source', sa.String(20), nullable=False, server_default='fbref'))
...
def downgrade() -> None:
    ...
    op.create_unique_constraint(
        'uq_player_stats_snapshot',
        'player_stats',
        ['player_id', 'as_of_utc', 'league', 'season']
    )
